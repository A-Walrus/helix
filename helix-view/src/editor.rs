...
#[derive(Debug, Default, Clone, PartialEq, Eq, Serialize, Deserialize, Reflect, FromReflect)]
...
#[derive(Debug, Copy, Clone, PartialEq, Eq, Serialize, Deserialize, Reflect, FromReflect)]
